...
function BottomMenu() {
  ...
  return (
    <motion.div
      className=" w-full flex items-center z-50 p-4 pb-1 shadow-md justify-between bottom-0 absolute mt-auto bg-gradient-to-b from-muted/0 to-background border-indigo-700 mb-[0.2rem]"
            ...
            <>
              <Link href={href}>
                ...
                <Image
                  ...
                  className="z-10 ml-[.025rem] -mt-[0.2rem] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
                />
              </Link>
            </>
          ) : (
