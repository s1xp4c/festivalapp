...
function BottomMenu() {
  ...
  return (
    <motion.div
      className="w-full flex items-center p-4 shadow-md justify-between bottom-0.5 absolute"
          ...
          {Icon === BsFillChatFill ? (
            <>
              ...
              <Image
                ...
                className="z-10 ml-1 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
              />
            </>
          ) : (
